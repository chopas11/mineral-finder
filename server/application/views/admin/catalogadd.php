<div class="content">
    <div class="content-text">
        <form class="form" action="/admin/catalog/add" method="POST">
        ...
        <textarea id="form-bbcode-textarea" name="text" rows="20" placeholder="Текст описания" required></textarea>
        <div class="form-checkbox"><input type="checkbox" name="visible"> Показать на главной странице</div>
